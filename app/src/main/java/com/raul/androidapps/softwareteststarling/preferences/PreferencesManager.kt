package com.raul.androidapps.softwareteststarling.preferences
...
@Singleton
class PreferencesManager @Inject constructor(private var context: Context, private val encryption: Encryption) {
